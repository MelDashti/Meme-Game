                ...
                <Row key={gameIndex} className="mb-4 justify-content-center">
                    <Col xs={12} md={8}>
                        <Card className="mb-3 shadow">
                            <Card.Header className="bg-secondary text-white text-center">  {/* Changed to bg-dark for a navy-like blue */}
                                    ...
                                    {game.rounds.map((round, roundIndex) => (
                                        <Col key={roundIndex} xs={12} sm={6} md={4} className="mb-3">
                                            <Card className="h-100 bg-light">
                                                <Card.Img variant="top" src={round.memeUrl || 'default-image-url.jpg'} alt="Meme" onError={(e) => { e.target.onerror = null; e.target.src = 'default-image-url.jpg'; }} />
                                                <Card.Body>
                                                    <Card.Title className="text-secondary">Round {roundIndex + 1}</Card.Title>
